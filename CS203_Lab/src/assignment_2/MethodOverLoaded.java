...
public class MethodOverLoaded {
	...
	/**
	 * A --> Both are Invalid methods b/c they have d/t return type
	 */
...
/**
 * D --> All the methods are InValid methods b/c have 
 *  return type same signature name and d/t parameter 
 */
